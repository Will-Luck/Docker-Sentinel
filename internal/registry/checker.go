...
// image store.
func (c *Checker) CheckVersionedWithDigest(ctx context.Context, imageRef, knownDigest string, scope docker.SemverScope) CheckResult {
	result := CheckResult{ImageRef: imageRef}
	...
	newer := NewerVersionsScoped(tag, tagsResult.Tags, scope)
...
func (c *Checker) CheckVersioned(ctx context.Context, imageRef string, scope docker.SemverScope) CheckResult {
